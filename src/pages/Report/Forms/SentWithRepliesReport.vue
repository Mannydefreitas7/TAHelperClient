        ...
        <template v-slot:prepend>
          <q-icon name="event" class="cursor-pointer">
            <q-popup-proxy transition-show="scale" transition-hide="scale" ref="qStartDateProxyRef">
              <q-date today-btn color="primary" v-model="startDate" mask="YYYY-MM-DD" no-unset
        ...
        <template v-slot:prepend>
          <q-icon name="event" class="cursor-pointer">
            <q-popup-proxy transition-show="scale" transition-hide="scale" ref="qEndDateProxyRef">
              <q-date today-btn color="primary" v-model="endDate" mask="YYYY-MM-DD" no-unset
    ...
    methods: {
      ...
      async onGenerate() {
        try {
          ...
          const { fileName, file } = await reportApi.sentWithRepliesReport(payload);
