<template>
  <div>
    ...
    <div v-else>
      ...
      <div>
        Your qualification is about to expire. Please use the upload button
        below to upload an image of your updated proof of qualification.
      </div>
      <div>
        <q-uploader
...
export default {
  ...
  methods: {
    factoryFn(file) {
      return new Promise((resolve, reject) => {
        ...
        url.searchParams.append("deliveryMethod", "ServiceRequirementCPRCardResponse");
  ...
  data: () => {
    return {
      uploadedFileIds: [],
      requiredMediaTypes: [
        { id: 1, type: "CPRCardFront", name: "CPR Card - Front" },
      ],
      submitted: false,
      requiredFileCount: 1,
    };
